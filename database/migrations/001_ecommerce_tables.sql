-- Migration 001: Ecommerce tables
-- Run this against your existing database if you already have the auth tables
-- (users, otps, refresh_tokens, activity_logs, email_queue).
